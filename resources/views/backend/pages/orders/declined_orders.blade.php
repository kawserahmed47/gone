            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="https://product.geniusocean.com/geniuscart/admin/orders?status=declined">Declined
                                Orders</a>
                        </li>
                    </ul>
                </div>
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting_disabled" rowspan="1" colspan="1"
                                                        style="width: 203px;">Customer Email</th>
                                                    <th class="sorting_disabled" rowspan="1" colspan="1"
                                                        style="width: 190px;">Order Number</th>
                                                    <th class="sorting_disabled" rowspan="1" colspan="1"
                                                        style="width: 128px;">Total Qty</th>
                                                    <th class="sorting_disabled" rowspan="1" colspan="1"
                                                        style="width: 137px;">Total Cost</th>
                                                    <th class="sorting_disabled" rowspan="1" colspan="1"
                                                        style="width: 113px;">Options</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr class="odd">
