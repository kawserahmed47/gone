...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">Withdraw Earning</h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            <a href="https://product.geniusocean.com/geniuscart/admin/withdraw/earning">Withdraw Earning</a>
                        </li>
                    </ul>
                </div>
            </div>
        </div>
        <form action="https://product.geniusocean.com/geniuscart/admin/withdraw/earning" method="GET">
                ...
                <div class="row text-center p-3">
                    ...
                    <div class="col-sm-6 col-lg-4 offset-lg-2 col-md-6  mt-3">
                        <input type="text" autocomplete="off" class="input-field discount_date hasDatepicker"
                            value="" name="start_date" placeholder="Enter Date" id="dp1673787915515">
                    </div>
                    <div class="col-sm-6 col-lg-4 col-md-6  mt-3">
                        <input type="text" autocomplete="off" class="input-field discount_date hasDatepicker"
                            value="" name="end_date" placeholder="Enter Date" id="dp1673787915516">
                    </div>
                    ...
                    <div class="col-lg-12">
                        <p class="text-center"> <b> Total Earning : $122</b></p>
                                    ...
                                    <table id="geniustable"
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a
                                                        href="https://product.geniusocean.com/geniuscart/admin/order/2/invoice">
                                            ...
                                            <tr role="row" class="even">
                                                ...
                                                <td>
                                                    <a
                                                        href="https://product.geniusocean.com/geniuscart/admin/order/3/invoice">
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a
                                                        href="https://product.geniusocean.com/geniuscart/admin/order/4/invoice">
                                            ...
                                            <tr role="row" class="even">
                                                ...
                                                <td>
                                                    <a
                                                        href="https://product.geniusocean.com/geniuscart/admin/order/5/invoice">
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a
                                                        href="https://product.geniusocean.com/geniuscart/admin/order/6/invoice">
                                            ...
                                            <tr role="row" class="even">
                                                ...
                                                <td>
                                                    <a
                                                        href="https://product.geniusocean.com/geniuscart/admin/order/8/invoice">
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a
                                                        href="https://product.geniusocean.com/geniuscart/admin/order/9/invoice">
                                            ...
                                            <tr role="row" class="even">
                                                ...
                                                <td>
                                                    <a
                                                        href="https://product.geniusocean.com/geniuscart/admin/order/12/invoice">
